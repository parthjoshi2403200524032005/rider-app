      ...
      <nav className="bg-gradient-to-r from-gray-800 via-gray-700 to-gray-800 p-4 fixed top-0 w-full z-50">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex space-x-4">
            ...
            <button className="text-white hover:text-gray-400 hover:bg-white cursor-pointer transition duration-400 ease-in-out border-inherit border-2 border-solid pl-[10px] pr-[10px] rounded ">Shop Now</button>
              {isLoggedIn ? (
                <button
