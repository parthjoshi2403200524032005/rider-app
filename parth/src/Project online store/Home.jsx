...
const Navbar = () => {
  ...
  // const handleClick = axios.post("http://localhost:3000/").then((res) => console.log(res.data));
  // console.log(handleClick)
  return (
    <>
      <div className="bg-[black]">
        <nav
          className={`bg-[#202124] p-4 fixed top-0 w-full z-50 h-[80px] hover:scale-105 transition-transform  cursor-pointer transition duration-[450ms] ease-in-out  ${
